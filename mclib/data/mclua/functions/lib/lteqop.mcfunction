...
execute if score temp1 _luatmp <= temp2 _luatmp run data modify storage mclua:_data data.return set value 1
execute unless score temp1 _luatmp <= temp2 _luatmp run data remove storage mclua:_data data.return